...
// Code Here
let total = myNumbers.reduce((total, element) => total + element, 0);
//////////////////PROBLEM 17////////////////////
...
// Code Here
forTheLoveOfGeorge = notGeorge.map((element, i) => {
...
// Code Here
let totallyAwesome = people.reduce((total, element) => element.awesomeLevel + total, 0); 